package warmer.neo4j.datamigrate.util;
...
public class Neo4jUtil {
     ...
     * @return
     */
    public List<HashMap<String, Object>> GetValue(String cypherSql) {
            ...
            if (result.hasNext()) {
                ...
                for (Record recordItem : records) {
                    ...
                    for (Pair<String, Value> pair : f) {
                        rss.put(pair.key(),pair.value().asString());
                    }
                    ents.add(rss);
                }
            }
     ...
     * 返回单个节点信息
     */
    public HashMap<String, Object> getOneNode(String cypherSql){
